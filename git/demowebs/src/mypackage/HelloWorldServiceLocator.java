...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements mypackage.HelloWorldService {
    ...
    public mypackage.HelloWorld getHelloWorldPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mypackage.HelloWorldPortBindingStub _stub = new mypackage.HelloWorldPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (mypackage.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                mypackage.HelloWorldPortBindingStub _stub = new mypackage.HelloWorldPortBindingStub(new java.net.URL(HelloWorldPort_address), this);
                _stub.setPortName(getHelloWorldPortWSDDServiceName());
                return _stub;
            }
        }

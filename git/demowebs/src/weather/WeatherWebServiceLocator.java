...
public class WeatherWebServiceLocator extends org.apache.axis.client.Service implements weather.WeatherWebService {
 ...
 */
    ...
    public weather.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public weather.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            weather.WeatherWebServiceSoap12Stub _stub = new weather.WeatherWebServiceSoap12Stub(portAddress, this);
    ...
    public weather.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public weather.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            weather.WeatherWebServiceSoap_BindingStub _stub = new weather.WeatherWebServiceSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (weather.WeatherWebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                weather.WeatherWebServiceSoap12Stub _stub = new weather.WeatherWebServiceSoap12Stub(new java.net.URL(WeatherWebServiceSoap12_address), this);
                _stub.setPortName(getWeatherWebServiceSoap12WSDDServiceName());
                return _stub;
            }
            if (weather.WeatherWebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                weather.WeatherWebServiceSoap_BindingStub _stub = new weather.WeatherWebServiceSoap_BindingStub(new java.net.URL(WeatherWebServiceSoap_address), this);
                _stub.setPortName(getWeatherWebServiceSoapWSDDServiceName());
                return _stub;
            }
        }
